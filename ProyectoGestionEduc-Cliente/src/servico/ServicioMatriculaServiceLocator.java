...
public class ServicioMatriculaServiceLocator extends org.apache.axis.client.Service implements servico.ServicioMatriculaService {
    ...
    private java.lang.String ServicioMatricula_address = "http://localhost:8080/ProyectoGestionEduc-Servicio/services/ServicioMatricula";
    ...
    public servico.ServicioMatricula getServicioMatricula() throws javax.xml.rpc.ServiceException {
    ...
    public servico.ServicioMatricula getServicioMatricula(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servico.ServicioMatriculaSoapBindingStub _stub = new servico.ServicioMatriculaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servico.ServicioMatricula.class.isAssignableFrom(serviceEndpointInterface)) {
                servico.ServicioMatriculaSoapBindingStub _stub = new servico.ServicioMatriculaSoapBindingStub(new java.net.URL(ServicioMatricula_address), this);
                _stub.setPortName(getServicioMatriculaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servico", "ServicioMatriculaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servico", "ServicioMatricula"));
        }
