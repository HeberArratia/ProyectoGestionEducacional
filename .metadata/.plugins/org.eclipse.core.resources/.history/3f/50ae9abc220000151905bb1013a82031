...
import org.orm.*;
public class ListGestionEducacionalData {
	...
	public static void main(String[] args) {
		try {
			ListGestionEducacionalData listGestionEducacionalData = new ListGestionEducacionalData();
			try {
				listGestionEducacionalData.listTestData();
				//listGestionEducacionalData.listByCriteria();
			}
			finally {
