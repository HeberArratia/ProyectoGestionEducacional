...
public class MensualidadDAO {
	...
	public static boolean save(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
