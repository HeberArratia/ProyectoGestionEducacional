...
public class DirectorDAO {
	...
	public static boolean save(orm.Director director) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Director director) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Director director) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Director director) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
