...
public class CursoDAO {
	...
	public static boolean save(orm.Curso curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Curso curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Curso curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Curso curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
