...
public class EstudianteDAO {
	...
	public static boolean save(orm.Estudiante estudiante) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Estudiante estudiante) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Estudiante estudiante) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Estudiante estudiante) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
