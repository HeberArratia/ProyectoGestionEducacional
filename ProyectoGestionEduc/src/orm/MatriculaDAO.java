...
public class MatriculaDAO {
	...
	public static boolean save(orm.Matricula matricula) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(matricula);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Matricula matricula) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(matricula);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Matricula matricula) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(matricula);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Matricula matricula) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(matricula);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
