...
public class Sueldo_profesorDAO {
	...
	public static boolean save(orm.Sueldo_profesor sueldo_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(sueldo_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Sueldo_profesor sueldo_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(sueldo_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Sueldo_profesor sueldo_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(sueldo_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Sueldo_profesor sueldo_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(sueldo_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
