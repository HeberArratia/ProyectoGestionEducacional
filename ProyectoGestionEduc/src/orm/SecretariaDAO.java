...
public class SecretariaDAO {
	...
	public static boolean save(orm.Secretaria secretaria) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(secretaria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Secretaria secretaria) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(secretaria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Secretaria secretaria) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(secretaria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Secretaria secretaria) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(secretaria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
