...
public class JefeadministracionDAO {
	public static Jefeadministracion loadJefeadministracionByORMID(int id) throws PersistentException {
		try {
			PersistentSession session = orm.GestionEducacionalPersistentManager.instance().getSession();
	...
	public static boolean save(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
