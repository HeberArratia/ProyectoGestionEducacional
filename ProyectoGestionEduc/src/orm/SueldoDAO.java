...
public class SueldoDAO {
	...
	public static boolean save(orm.Sueldo sueldo) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(sueldo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Sueldo sueldo) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(sueldo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Sueldo sueldo) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(sueldo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Sueldo sueldo) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(sueldo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
