...
public class PersonaDAO {
	...
	public static boolean save(orm.Persona persona) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Persona persona) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Persona persona) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Persona persona) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
