...
public class ProfesorDAO {
	...
	public static boolean save(orm.Profesor profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Profesor profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Profesor profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Profesor profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
