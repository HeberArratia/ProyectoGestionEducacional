...
public class Curso_profesorDAO {
	...
	public static boolean save(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
