...
public class Estudiante_cursoDAO {
	...
	public static boolean save(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().saveObject(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().deleteObject(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().refresh(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.GestionEducacionalPersistentManager.instance().getSession().evict(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
