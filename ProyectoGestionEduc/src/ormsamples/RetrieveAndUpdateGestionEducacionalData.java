...
import org.orm.*;
public class RetrieveAndUpdateGestionEducacionalData {
	public void retrieveAndUpdateTestData() throws PersistentException {
		PersistentTransaction t = orm.GestionEducacionalPersistentManager.instance().getSession().beginTransaction();
		try {
	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				//retrieveAndUpdateGestionEducacionalData.retrieveByCriteria();
			}
			finally {
