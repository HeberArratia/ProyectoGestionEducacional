			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(btnAtras, GroupLayout.PREFERRED_SIZE, 68, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
							.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
								.addComponent(btnAtras_1, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
								.addGap(81)
								.addComponent(btnRegistrarSueldo, GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
